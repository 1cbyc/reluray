      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto">
            Advanced deep learning technology for accurate chest X-ray analysis. Fast, reliable, and built for medical professionals.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-4">
              {["CPU", "Memory", "Network", "Storage"].map((metric, idx) => {
                // Use stable values based on metric name to avoid hydration mismatch
                const values = { CPU: 94, Memory: 61, Network: 72, Storage: 63 }
                return (
                  <div key={metric} className="text-center">
                    <div className="text-2xl font-bold text-white mb-1">{values[metric as keyof typeof values]}%</div>
