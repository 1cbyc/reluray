  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/hero-medical-bg.jpg)',
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-zinc-400">Free • No Card Required</span>
        </motion.div>
        ...
        >
          Advanced medical image analysis. Get instant, accurate chest X-ray analysis powered by deep learning. 
        ...
        >
          ...
          <p className="text-sm text-zinc-500">
            Trusted by <span className="text-zinc-300 font-medium">5,000+</span> medical professionals worldwide
          </p>
        </motion.div> */}
      </div>
    </section>
