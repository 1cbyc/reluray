...
const logos = [
  { name: "Mayo Clinic", initial: "M" },
  { name: "Johns Hopkins", initial: "J" },
  { name: "Cleveland Clinic", initial: "C" },
  { name: "Stanford Health", initial: "S" },
  { name: "Mass General", initial: "M" },
  { name: "UCSF Health", initial: "U" },
  { name: "NYU Langone", initial: "N" },
  { name: "Duke Health", initial: "D" },
]
...
export function LogoMarquee() {
  ...
  return (
    <section ref={ref} className="py-16 overflow-hidden">
      ...
      >
        <p className="text-sm text-zinc-500 uppercase tracking-wider font-medium">Trusted by leading healthcare institutions</p>
      </motion.div>
            ...
            >
              <div className="flex items-center gap-2 text-zinc-400">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/30 flex items-center justify-center">
                  <span className="text-xs font-bold text-blue-400">{logo.initial}</span>
                </div>
