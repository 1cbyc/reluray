    ...
    >
      ...
      >
        ...
        <a href="#" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white hidden sm:block">ReluRay</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Button size="sm" className="shimmer-btn bg-gradient-to-r from-blue-500 to-cyan-500 text-white hover:from-blue-600 hover:to-cyan-600 rounded-full px-4">
            Try Now
          </Button>
        </div>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <Button className="shimmer-btn bg-gradient-to-r from-blue-500 to-cyan-500 text-white hover:from-blue-600 hover:to-cyan-600 rounded-full">Try Now</Button>
          </div>
        </motion.div>
      )}
    </motion.header>
