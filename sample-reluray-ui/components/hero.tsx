    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-zinc-400">AI-Powered Medical Diagnostics</span>
        </motion.div>
        ...
        >
          Revolutionary AI technology that analyzes chest X-rays for pneumonia detection in seconds. 
          Empowering healthcare professionals with accurate, instant diagnostic insights.
        </motion.p>
        ...
        >
          <Button
            size="lg"
            className="shimmer-btn bg-gradient-to-r from-blue-500 to-cyan-500 text-white hover:from-blue-600 hover:to-cyan-600 rounded-full px-8 h-12 text-base font-medium shadow-lg shadow-blue-500/20"
          >
            Analyze X-Ray Now
        ...
        >
          ...
          <p className="text-sm text-zinc-500">
            Trusted by <span className="text-zinc-300 font-medium">500+</span> healthcare professionals worldwide
          </p>
        </motion.div>
      </div>
    </section>
